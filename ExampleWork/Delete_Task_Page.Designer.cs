...
{
	partial class Delete_Task_Page
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.button2.Text = "Finished Removing Task";
			this.button2.UseVisualStyleBackColor = true;
			this.button2.Click += new System.EventHandler(this.button2_Click);
			// 
			// button1
			// 
			this.button1.Location = new System.Drawing.Point(364, 75);
			...
			// textBox5
			// 
			this.textBox5.Location = new System.Drawing.Point(12, 169);
			...
			this.textBox2.Text = "Enter Finished Task Name";
			// 
			// Delete_Task_Page
			// 
			...
			this.Name = "Delete_Task_Page";
			this.Text = "Delete_Task_Page";
